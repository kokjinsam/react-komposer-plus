...
* Added context into subscribe function. (PR by clayne11, see [here](https://github.com/kadirahq/react-komposer/pull/46))
...
* Separated all functions into modules. So now we can import individual function like this:
  ...
  ```
* Added `composeWithRedux`. Depreciate `react-komposer-redux`.
